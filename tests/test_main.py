...
def test_selftest_exits_zero_and_opens_no_window(
    ...
    monkeypatch.setattr(app, "start_window", fail)
...
def test_selftest_still_writes_a_log_file(
    ...
    monkeypatch.setattr(app, "start_window", lambda: None)
...
def test_a_normal_launch_opens_the_window(
    ...
    opened: list[bool] = []
    monkeypatch.setattr(app, "start_window", lambda: opened.append(True))
...
def test_a_crash_at_startup_is_logged_and_exits_nonzero(
    ...
    monkeypatch.setattr(app, "start_window", boom)
